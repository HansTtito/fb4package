...
0 errors | 0 warnings | 2 notes (see below)
...
* NOTE: `unable to verify current time` — network issue on the local check
  machine; does not appear on win-builder or GitHub Actions.
...
* Local Windows 11, R 4.5.1 — 0 errors, 0 warnings, 2 notes (see above)
* win-builder R-release (R 4.6.0, Windows Server 2022) — 0 errors, 0 warnings, 1 note (`-Wa,-mbig-obj`)
* win-builder R-devel (R Under development 2026-06-08 r90120, Windows Server 2022) — 0 errors, 0 warnings, 1 note (`-Wa,-mbig-obj`)
